...
////////////////////////////////////////////////
	...
	function setcolor(color){
		...
		$('.newcss').html("<style>."+svg[svgnum]+"{display:block;}.backgroundsvg{fill:"+opcolor2+";stroke:"+opcolor2+";}.shareblock,.intro,html,body,footer{background:"+opcolor+";}.animwrap a svg,.tdf,#cloud,#cloud2,.tdflogo{fill:"+color+";}.color{color:"+color+";}::selection{background:"+color+";}a,.linkstyle,.info,a:hover,.linkstyle:hover,a:hover svg,.sociala:hover,.intro,.optionmobile.copyios.shareiconwrap,.text,a:hover svg#cloud,::selection{color:"+color+";border-color:"+color+";}</style>");
		svgnum = svgnum + 1;
		if (svgnum >= 6){
			svgnum = 0;
		}
