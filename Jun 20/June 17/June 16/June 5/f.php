	...
	<div class="container">
		...
		<div class="row">
			<div class="info text-center grid-full space-top">
				<h3>
					<span class="linkstyle">Send note to a friend</span>
					
					<span class="h6 color">c<br/>ol<br/>or?</span>
					
					<span class="animwrap">
						<a class="bold" href="http://tendollarfonts.com/collections/new-fonts/products/ransom">Download Random</a>
						<a class="dc" href="http://tendollarfonts.com/collections/new-fonts/products/ransom">
		...
		<div class="row">
			<div class="colophon space-top">
				<div class="credit">
					<h6>
						<a href="http://tendollarfonts.com/">Download Random exclusively at TDF</a>
						<br/>
						<a href="http://www.emilkozole.com/">Random designed by Emil Kozole</a>
						<br/>
						<a href="http://quinnkeaveney.com/">Website built by Quinn Keaveney</a>
					</h6>
				</div>

				<div class="social">
					<h6 class="linkstyle">Site info</h6>
