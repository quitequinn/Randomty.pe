	...
	<div class="container">
		...
		<div class="row">
			<div class="info text-center grid-full space-top">
				<h3>
					...
					<span class="animwrap">
					<a href="">
						<a class="bold" href="http://tendollarfonts.com/collections/new-fonts/products/random">Download Random</a>
						<a class="dc" href="http://tendollarfonts.com/collections/new-fonts/products/random">
		...
		<div class="row">
			<div class="colophon space-top">
				...
				<div class="social">
					<a class="dc" target="_blank" href="http://instagram.com/tendollarfonts">1</a>
					<a class="dc" target="_blank" href="https://twitter.com/tendollarfonts">2</a>
					<a class="dc" target="_blank" href="https://www.facebook.com/TenDollarFonts">3</a>
					<a class="dc" target="_blank" href="https://www.behance.net/dmcxtdf">4</a>
				</div>
