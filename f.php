...
<footer>
	<div class="container">
		...
		<div class="row">
			<div class="info text-center grid-full space-top">
				<h3>
					<span class="linkstyle inline-block">Share my message</span>
					
					<span class="h6 color">olo<br/>c&nbsp;r<br/>olo</span>
					
					<span class="animwrap">
						<a target="_blank" href="http://tendollarfonts.com/collections/new-fonts/products/random">
							<a class="bold" target="_blank" href="http://tendollarfonts.com/collections/new-fonts/products/random">Download Random</a>
							<a class="dc" target="_blank" href="http://tendollarfonts.com/collections/new-fonts/products/random">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="cloud" class="bound" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"xml:space="preserve">
								...
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="cloud2" class="arrow" x="0px" y="0px"width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"xml:space="preserve">
		...
		<div class="row">
			<div class="colophon space-top">

				<div class="social">
					<a class="dc" href="http://instagram.com/tendollarfonts">1</a>
					<a class="dc" href="https://twitter.com/tendollarfonts">2</a>
					<a class="dc" href="https://www.facebook.com/TenDollarFonts">3</a>
					<a class="dc" href="https://www.behance.net/dmcxtdf">4</a>
				</div>

				<div class="credit">
					<h6>
						<a target="_blank" href="http://www.emilkozole.com/">Random designed by Emil Kozole</a>
						<br/>
						<a target="_blank" href="http://quinnkeaveney.com/">Website built by Quinn Keaveney</a>
					</h6>
				</div>
			</div>
		</div>
	</div>
	<h6 class="infoclick linkstyle">i</h6>
	...
	<script>
		var _gaq=[['_setAccount','UA-52141382-1'],['_trackPageview']];
